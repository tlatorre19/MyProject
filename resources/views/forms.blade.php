                ...
                <div class="card card-round" style="border:none; box-shadow: 0 4px 24px rgba(0,0,0,0.08);">
                    ...
                    <div class="card-header border-0 pb-0 pt-4 px-4"
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h5 class="fw-bold mb-0" style="color:#1b4332;">New Item Report</h5>
                        ...
                        <form action="{{ route('forms.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <label class="form-label fw-semibold text-uppercase"
                                           style="font-size:11px; color:#555; letter-spacing:0.05em;">
                                        <i class="fas fa-filter me-1 text-success"></i> Type
                                    </label>
                                    <select name="type"
                            ...
                            {{-- Date + Reporter Name (side by side) --}}
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label fw-semibold text-uppercase"
                                           style="font-size:11px; color:#555; letter-spacing:0.05em;">
                                        <i class="fas fa-calendar me-1 text-success"></i> Date Lost/Found
                                    </label>
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-semibold text-uppercase"
                                       style="font-size:11px; color:#555; letter-spacing:0.05em;">
                                    <i class="fas fa-phone me-1 text-success"></i> Contact No.
                                </label>
                            ...
                            <div class="mb-4">
                                ...
                                <div id="dropZone" style="border: 2px dashed #d0e8d8; border-radius:12px;
                                     padding:2rem; text-align:center; cursor:pointer;
                                     background:#f6fbf8; position:relative; transition: all 0.2s;">
                                    ...
                                    <div id="uploadPrompt">
                                        ...
                                        <div style="font-weight:600; color:#2d6a4f; font-size:14px;">
                                    ...
                                    <div id="previewBox" style="display:none; margin-top:1rem;">
                                        <img id="previewImg" src="" alt="Preview"
                                             style="max-height:180px; border-radius:10px; border:2px solid #d0e8d8;">
                                        <br>
...
dropZone.addEventListener('dragleave', () => {
    dropZone.style.borderColor = '#d0e8d8';
